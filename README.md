...
[![Platform](https://img.shields.io/badge/iOS-规范-000000?style=flat-square&logo=apple&logoColor=white)]()
[![License](https://img.shields.io/badge/license-MIT-green?style=flat-square)]()
[![Hackathon](https://img.shields.io/badge/清客松-2026-ff69b4?style=flat-square)]()

[🎮 在线试玩](#-快速开始) · [📖 玩法速览](#-核心玩法5-天-1-局) · [🎨 设计语言](#-ui-设计) · [🗺️ 路线图](#-路线图)
...
| 痛点 | 我们的解法 |
| :--- | :--- |
| 想学投资但不敢拿真钱入场 | 💸 100 万**模拟资金**，零风险体验市场波动 |
...
> **巴菲特：** 先不要急着讨论买不买。
> 投资最重要的问题不是股价，而是你是否真正理解这家公司。
> 茅台本质上不是一家白酒公司。它更接近于一个拥有极强品牌垄断能力的消费品企业。
> 消费者购买茅台，并不只是购买酒精饮料……
> 购买的是：社交价值 · 礼赠价值 · 收藏价值 · 身份象征。
...
| 线索类型 | AI 总结内容 |
| :--- | :--- |
| 📊 行为异常 | 谁在关键消息出现前**提前**建仓/减仓 |
| 💹 收益异常 | 账户表现平平但**积分异常**上升 |
| 🕳️ 信息链 | 哪条假消息影响了哪个玩家 |
...
| 角色 | 颜色 | 用途 |
| :--- | :--- | :--- |
| 🟣 主色 | 霓虹品红 `#FF00FF` | 关键边框 / 主按钮 / 激活态 |
| 🟪 容器 | 深紫 `#2D0A4E` | 面板 / 卡片 |
| 🔵 辅色 | 电光青 `#00FFFF` | 数据高亮（限速使用） |
| ⬛ 背景 | 黑色 CRT + 扫描线 | 全局背景 |

> 拒绝：过于刺眼的霓虹、堆叠色块、混乱间距、玻璃拟态、圆角 SaaS 风、3D 渲染、模糊文字。
...
### ✅ 已完成
- [x] 冷启动 30 秒用户建档（4 道题匹配投资人格）
- [x] 投资人格分类：保守 / 稳健 / 价值投资 / 进取成长
- [x] 50 支股票池 + 7 大板块游戏档案
- [x] AI 智囊团基础 Agent（巴菲特 / 段永平 / 彼得·林奇）
- [x] 卧底身份机制 + 假消息系统
- [x] 5 日标准局游戏流程
- [x] AI 毒舌主持人战报
- [x] 像素风 UI 设计规范
